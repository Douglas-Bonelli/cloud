package br.com.intelligence.project.cloud.config;
...
public class WebServiceConfig extends WsConfigurerAdapter {
	...
	@Bean
	public XsdSchema orgaoSchema(){
		return new SimpleXsdSchema( new ClassPathResource("orgao-information.xsd") );
	}
	...
	@Bean(name="orgao")
	public DefaultWsdl11Definition DefaultWsdl11Definition( XsdSchema orgaoSchema ){
